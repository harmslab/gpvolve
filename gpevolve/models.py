...
def wright_fisher(genotypes, phenotypes, mu=1e-6, N=1e6, diploid=False):
    ...
    fitness_matrix_0 = np.multiply(phenotypes.reshape((-1,1)), nb_mat)
    fitness_matrix_1 = np.multiply(nb_mat, phenotypes)
